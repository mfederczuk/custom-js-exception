...
export default class Exception extends Error {
	 ...
	 * The message, name and stack from the `Error` object will be copied over to the `Exception` instance.
	 *
	 * @param err The `Error` instance to make to an `Exception` instance.
	 *
